...
- **Sanitization of CRM content fed back to the model** remains the agent-runtime's job (ADR-005 Tier-2), not the thin adapter's — unchanged, but now explicitly load-bearing. Tracked as a TO RESOLVE.
